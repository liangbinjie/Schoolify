...
import courseEnrollmentRouter from './routes/courseEnrollmentRoute.js';
...
app.use('/api/cassandra-files', cassandraFileRouter);
app.use("/api/neo4j", neo4jRouter);
app.use("/api/enrollment", courseEnrollmentRouter);
